...
const Activities = () => {
  const activities = [
    ...
    { date: '2020-08-30', url: 'https://github.com/isucon/isucon10-qualify/pull/117', title: 'isucon10でPerlの参考実装移植をしました' },
    ...
    { date: '2021-08-13', url: 'https://github.com/isucon/isucon11-qualify/pull/1099', title: 'isucon11でPerlの参考実装移植をしました' },
    ...
    { date: '2022-07-14', url: 'https://github.com/isucon/isucon12-qualify/pull/164', title: 'isucon12でPerlの参考実装移植をしました' },
