...
AI Agentは指示したサイトをWeb FetchしてCSSを読み込み、期待通りスタイルを当てた。MCP、スキルそういった設定は一切ない。圧倒的に楽。今までの資料作りなら、時間をかけてスタイル調整するか、プリセットのスタイルでごまかしていた。
